...
<html>
    <head>
        ...
        <title>Erro 404 | Projeto Fideliza</title>
    </head>
    <style>
    ...
    <body>
        <div class="hero-unit center">
            <h1> <fmt:message key="erro.404" /> <br />
                <small><font face="Tahoma" color="red">Erro 404 | Projeto Fideliza</font></small>
            </h1>
            <br />
            <a href="javascript:history.back(0);" class="btn btn-large btn-primary"><i class="icon-arrow-left icon-white"></i> Voltar !</a>
        </div>
    </body>
</html>
